...
moduleFor('service:affinity-engine/animator-animejs', 'Unit | Service | affinity engine/animator animejs', {
...
test('animate executes anime on the provided element', function(assert) {
  assert.expect(1);
